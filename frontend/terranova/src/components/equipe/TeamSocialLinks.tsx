import type { TeamMemberSocial } from "@/types/equipe";
...
export function TeamSocialLinks({
  ...
  const buttonClass = variant === "dark" ? iconButtonDark : iconButtonLight;

  const links = [
    {
      href: social.linkedin,
      label: `LinkedIn de ${memberName}`,
      icon: LinkedinIcon,
    },
    {
      href: social.github,
      label: `GitHub de ${memberName}`,
      icon: GithubIcon,
    },
  ...
  return (
    <div className="flex items-center gap-2" data-team-social>
